...
test("evidence tool routes use current taxonomy and escape paths", () => {
  ...
  assert.match(shapeDetector, /<title>Shape\. \/\/ Atlas Systems<\/title>/);
  ...
  assert.match(shapeDetector, /data-evidence-mode="unknown" data-runtime-state="checking" aria-live="polite">Probing live/);
});
