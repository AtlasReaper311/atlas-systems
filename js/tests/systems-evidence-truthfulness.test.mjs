...
test("Systems detail routes consume Interface Kit v0.5.0 evidence semantics", () => {
  ...
  assert.match(routes.evidence, /systems-evidence-truthfulness\.css\?v=20260911-estate-view/);
});
...
test("Correction modules keep public rendering bounded and secret-free", () => {
  for (const path of [
    ...
    "systems/evidence/estate-profile.js",
    "systems/evidence/estate-view.js",
