...
test("Phase 8 keeps corrected controls and dense regions accessible", () => {
  ...
  assert.match(css, /\.atlas-mobile-nav__item \{ width: 100%; min-width: 0; min-height: 64px;/);
...
test("historical diagnostic console exceptions are fully retired", () => {
  assert.deepEqual(baseline.families, []);
});
