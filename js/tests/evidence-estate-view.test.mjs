...
test("Evidence Console keeps Change and Service Views and adds Estate navigation without secrets", () => {
  ...
  assert.match(page, /systems\/evidence\/estate-view\.js\?v=20260911-detail/);
  assert.match(page, /systems\/evidence\/evidence-views\.js\?v=20260911-detail/);
  assert.match(page, /systems-evidence-estate-view\.css\?v=20260911-detail/);
