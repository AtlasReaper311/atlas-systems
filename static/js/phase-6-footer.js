...
body[data-lab-route="bearing"] main{width:100%;max-width:none;margin:0;padding:0!important}body[data-lab-route="bearing"] .bearing{height:calc(100svh - 111px);min-height:560px}.bearing .controls button.act{min-width:44px;min-height:44px;box-sizing:border-box}.atlas-mobile-nav{display:none}.atlas-footer{position:relative;z-index:2}.atlas-footer,.atlas-footer *{font-family:var(--f-data)!important;font-weight:400!important}.atlas-footer a{min-width:44px;min-height:44px;display:inline-flex;align-items:center;box-sizing:border-box}
