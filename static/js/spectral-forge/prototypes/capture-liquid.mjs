...
const MOD = "/static/js/spectral-forge/prototypes/field-proto-liquid.js";
...
async function metrics() {
  return page.evaluate(async () => {
    ...
    return {
      ...
      maxL,
      renderer: c.dataset.fieldRenderer,
...
await page.locator(".forge-play .forge-field-stage").screenshot({ path: path.join(OUT, "liquid-normal-3s.png") });
...
await page.locator(".forge-play .forge-field-stage").screenshot({ path: path.join(OUT, "liquid-cascade-20s.png") });
