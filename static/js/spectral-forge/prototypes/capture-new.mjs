...
const PROTOS = [
  { id: "schlieren", module: "/static/js/spectral-forge/prototypes/field-proto-schlieren.js" },
  { id: "interference", module: "/static/js/spectral-forge/prototypes/field-proto-interference.js" },
  { id: "cymatic", module: "/static/js/spectral-forge/prototypes/field-proto-cymatic.js" },
  { id: "ferro", module: "/static/js/spectral-forge/prototypes/field-proto-ferro.js" },
];
...
async function metrics() {
  return page.evaluate(async () => {
    ...
    return { raf, litPct: Math.round((lit / total) * 100), maxL, renderer: c.dataset.fieldRenderer ?? null };
  });
}
...
for (const proto of PROTOS) {
  ...
  console.log(proto.id, "NORMAL", mN);
  ...
  console.log(proto.id, "CASCADE", mC);
  if (await pause.count()) await pause.click().catch(() => {});
}
await browser.close();
